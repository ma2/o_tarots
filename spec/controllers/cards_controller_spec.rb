  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved card as @card" do
        ...
        post :create, {:card => { "number" => "invalid value" }}, valid_session
        expect(assigns(:card)).to be_a_new(Card)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested card" do
        ...
        expect_any_instance_of(Card).to receive(:update).with({ "number" => "1" })
        put :update, {:id => card.to_param, :card => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the card as @card" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Card.any_instance.stub(:save).and_return(false)
        put :update, {:id => card.to_param, :card => { "number" => "invalid value" }}, valid_session
        expect(assigns(:card)).to eq(card)
      end
